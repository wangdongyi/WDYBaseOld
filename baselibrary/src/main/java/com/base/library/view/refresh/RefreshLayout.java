        ...
        if (children > 0) {
            for (int i = 0; i < children; i++) {
                if (getChildAt(i) instanceof RelativeLayout)
                    for (int j = 0; j < ((RelativeLayout) getChildAt(i)).getChildCount(); j++) {
                        if (((RelativeLayout) getChildAt(i)).getChildAt(j) instanceof RecyclerView) {
                        ...
                        if (((RelativeLayout) getChildAt(i)).getChildAt(j) instanceof LinearLayout) {
                            footerView = (LinearLayout) ((RelativeLayout) getChildAt(i)).getChildAt(i);
                            footerView.setVisibility(GONE);
                        }
                    }
