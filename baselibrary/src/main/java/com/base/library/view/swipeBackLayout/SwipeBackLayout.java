...
//        int widthSize = MeasureSpec.getSize(widthMeasureSpec);
        int widthSize = CodeUtil.getScreenWidth(mActivity);
//        int heightSize = MeasureSpec.getSize(heightMeasureSpec);
        int heightSize = CodeUtil.getScreenHeight(mActivity);
        // ======================== 新加的 END ========================
        ...
        // ======================== 新加的 START ========================
        if (!mIsNavigationBarOverlap && CodeUtil.isPortrait(mActivity)) {
            maxLayoutHeight -= CodeUtil.getNavigationBarHeight(mActivity);
        }

        if (mIsNavigationBarOverlap && !CodeUtil.isPortrait(mActivity)) {
            widthSize += CodeUtil.getNavigationBarHeight(mActivity);
        }
        // ======================== 新加的 END ========================
